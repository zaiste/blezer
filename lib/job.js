...
class Job extends EventEmitter {
  constructor(queue, task, args, { scheduledAt } = {}) {
    super();
  ...
  static async remove(jid) {
    await redis.lremAsync(`blezer:active`, 1, jid)
    await redis.lremAsync(`blezer:processed`, 1, jid)
    await redis.lremAsync(`blezer:failed`, 1, jid)
  }
